...
| `any` for Discord objects                                        | Import from `@gambcord/discord-types`        | Type safety                         |
...
| `Gambcord.Plugins.plugins["X"]`                                   | `isPluginEnabled` + direct import           | Proper interop                      |
...
```typescript
import { User, Channel, Guild, GuildMember, Message, Role } from "@gambcord/discord-types";
```
...
// BAD
Gambcord.Plugins.plugins["OtherPlugin"].someFunction();
