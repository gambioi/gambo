        ...
        >
            {(_, { isShown }) => (
                <HeaderBarIcon
                    ...
                    onClick={() => setShow(v => !v)}
                    tooltip={isShown ? null : "Gambcord Toolbox"}
...
export default definePlugin({
    name: "GambcordToolbox",
    description: "Adds a button to the titlebar that houses Gambcord quick actions",
