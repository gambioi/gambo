...
import { FluxEvents } from "@gambo/discord-types";
...
export function addPatch(newPatch: Omit<Patch, "plugin">, pluginName: string, pluginPath = `Gambo.Plugins.plugins[${JSON.stringify(pluginName)}]`) {
