...
import { FluxEvents } from "@gambcord/discord-types";
...
export function addPatch(newPatch: Omit<Patch, "plugin">, pluginName: string, pluginPath = `Gambcord.Plugins.plugins[${JSON.stringify(pluginName)}]`) {
