...
import { gitRemote } from "@shared/gamboUserAgent";
                    ...
                    {!IS_WEB && (
                        <>
                            ...
                            <QuickAction
                                ...
                                action={() => GamboNative.settings.openFolder()}
                            />
                        </>
                    )}
                    <QuickAction
                        ...
                        action={() => GamboNative.native.openExternal("https://github.com/" + gitRemote)}
                    />
                </QuickActionCard>
            </section>
...
export default wrapTab(GamboSettings, "Gambo Settings");
