...
import { gitRemote } from "@shared/gambcordUserAgent";
        ...
        <SettingsTab>
            {isDonor(user?.id)
                ...
                : (
                    <SpecialCard
                        ...
                        description="Please consider supporting the development of Gambcord by donating!"
            ...
            {isPluginDev(user?.id) && (
                <SpecialCard
                    ...
                    description="Since you've contributed to Gambcord you now have a cool new badge!"
                    ...
                    {!IS_WEB && (
                        <>
                            ...
                            <QuickAction
                                ...
                                action={() => GambcordNative.settings.openFolder()}
                            />
                        </>
                    )}
                    <QuickAction
                        ...
                        action={() => GambcordNative.native.openExternal("https://github.com/" + gitRemote)}
                    />
                </QuickActionCard>
            </section>
...
export default wrapTab(GambcordSettings, "Gambcord Settings");
